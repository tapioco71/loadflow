       ...
       do
         (case (node-struct-kind node)
           (:generation
            (case (bond-struct-kind (node-struct-bond node))
              (:p-q
               (incf (grid:gref voltages-vector (node-struct-tag node)) (if (problem-struct-beta problem)
                                                                 (* (grid:gref (problem-struct-beta problem) (node-struct-tag node))
                                                                    (grid:gref delta-voltages-vector (node-struct-tag node)))
                                                                 (grid:gref delta-voltages-vector (node-struct-tag node))))
               (incf (grid:gref thetas-vector (node-struct-tag node)) (if (problem-struct-alpha problem)
                                                               (* (grid:gref (problem-struct-alpha problem) (node-struct-tag node))
